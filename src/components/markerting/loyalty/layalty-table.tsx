...
import { loyalty } from "@/mocks/layalty";
import { loyaltyTableColumns } from "./loyalty-table-header";
import { translateLoyaltyTableKeys } from "@/utils/translate-loyalty-table-keys";
						...
						{table
							...
							.map((column) => {
								return (
									...
									>
										{translateLoyaltyTableKeys(column.id)}
									</DropdownMenuCheckboxItem>
								);
							})}
					</DropdownMenuContent>
				...
				<Table>
					...
					<TableBody>
						{table.getRowModel().rows?.length ? (
							...
							<TableRow>
								<TableCell
									colSpan={loyaltyTableColumns.length}
